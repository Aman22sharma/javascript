  ...
  return (
    <div className="station d-flex justify-content-between">
      ...
      <div className="btns d-flex justify-content-end align-items-start ml-3 ml-md-5">
        <button
          className="rounded-circle btn btn-outline-secondary play d-flex justify-content-center align-content-center mr-3"
        ...
        <button
          className="rounded-circle btn btn-outline-dark pause d-flex justify-content-center align-items-center"
          data-sound={station.url}
        >
  ...
  return (
    <>
      <footer className="footer text-center">
        <p>&copy; Hasde Vasde Raho!</p>
        {stations && <p>Stations available for your entertainment: <strong>{stations.length}</strong></p>}
        <small>
          Message your favorite Punjabi station to me, I'll add or report broken ones&nbsp;
          <a
  ...
  return (
    <>
      <article className="info">
        <h1 className="info__title text-success">Japji</h1>
        <p className="info__subtitle text-white">
          Lightweight, Zero advertisement, Instant/Background playback, Your
          favorite Punjabi radio stations from Web updated regularly!
        </p>
      </article>
    </>
  );
